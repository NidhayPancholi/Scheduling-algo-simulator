...
<ol>
    ...
    <li>Upload it to Google Colab OR open it in your local jupyter environment.</li>
    <li>Run all cells</li>
    <li>We're using the ngrok library to deploy the simulator temporarily.</li>
    <li>The last cell will produce 2 links which will run the streamlit app on local port 8085 but as we're using ngrok to deploy, whatever is being run on the local port will be transferred to the link that has been generated by ngrok(3rd to last cell).</li>
    <li>Click on the link generated by ngrok and there you'll find the simulator.</li>
    <li>Select the algorithm, change the inputs if needed and you're good to go!</li>
</ol>
</p>
...
<p>
    ...
    <li>Download the Jupyter Notebook.</li>
    <li>Upload it to Google Colab OR open it in your local jupyter environment.</li>
    <li>We're creating a file named app.py which contains the code streamlit will use to deploy our web app,from the jupyter notebook </li>
    <li>We're using the ngrok library to deploy the simulator temporarily.</li>
    <li>Find the app.py file, any changes made will be reflected in the web app on re running the code.</li>
    <li>The app_layout function contains the layout of the streamlit app.</li>
    <li>For executing various algorithms, seperate functions are made for each algorithm which take the process information as input and give the gant chart as output.</li>
    <li>2 utility functions are made to create the gantt chart and to create a table containing the information as Turn around time,response time,waiting time,etc. for each process</li>
    <li>Save the changes made to the app.py file and reload the web page on which the simulator is running.</li>
